# Ours Privacy Go API Library

<!-- x-release-please-start-version -->

<a href="https://pkg.go.dev/github.com/stainless-sdks/ours-privacy-go"><img src="https://pkg.go.dev/badge/github.com/stainless-sdks/ours-privacy-go.svg" alt="Go Reference"></a>
...
```go
import (
	"github.com/stainless-sdks/ours-privacy-go" // imported as oursprivacy
)
```
...
```sh
go get -u 'github.com/stainless-sdks/ours-privacy-go@v0.0.1'
```
...
See the [full list of request options](https://pkg.go.dev/github.com/stainless-sdks/ours-privacy-go/option).
...
if err != nil {
	...
	panic(err.Error()) // GET "/track": 400 Bad Request { ... }
}
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/ours-privacy-go/issues) with questions, bugs, or suggestions.
